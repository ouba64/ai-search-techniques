...
public class ConvexPolygon extends Polygon {
	...
	public ConvexPolygon(ConvexPolygon c) {
	...
	public String toString() {
		...
		/*if(MonaLisa.DEBUG) {
			res = "p" + String.valueOf(System.identityHashCode(this)).substring(4);
		}*/
		if(MonaLisa.DEBUG) {
			Double total = 0d;
